...
const MealSchema = z.object({
  id: z.string().describe('The ID of the recipe. If from the available list, use the original ID. If newly generated, use a placeholder like "new-recipe-day-1-breakfast".'),
