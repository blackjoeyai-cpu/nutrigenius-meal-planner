...
const RegenerateSingleMealInputSchema = z.object({
  ...
  generationSource: z.enum(["catalog", "new", "combined"]).describe("The source for recipe generation."),
  mealToRegenerate: z.enum(["breakfast", "lunch", "dinner"]).describe("The specific meal to regenerate."),
